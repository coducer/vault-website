...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'About Us page content including hero image and mission details';
    displayName: 'About';
    pluralName: 'abouts';
    singularName: 'about';
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    details: Schema.Attribute.Component<'about.detail-item', true>;
...
export interface ApiCareerApplicationCareerApplication
  ...
  info: {
    description: 'Career applications submitted from the website';
  ...
  attributes: {
    coverLetterFile: Schema.Attribute.Media & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    cvFile: Schema.Attribute.Media & Schema.Attribute.Required;
    email: Schema.Attribute.Email & Schema.Attribute.Required;
    fullName: Schema.Attribute.String & Schema.Attribute.Required;
    jobLocation: Schema.Attribute.String;
    jobTitle: Schema.Attribute.String;
    jobUrl: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiCeoAnnualLetterCeoAnnualLetter
  ...
  info: {
    description: 'CEO annual letter entries with quote, avatar and image';
    displayName: 'CEO Annual Letter';
    pluralName: 'ceo-annual-letters';
    singularName: 'ceo-annual-letter';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    downloadFile: Schema.Attribute.Media<'images' | 'files'>;
    image: Schema.Attribute.Media<'images'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::ceo-annual-letter.ceo-annual-letter'
    > &
      Schema.Attribute.Private;
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Contact page content and admin email for form submissions';
    displayName: 'Contact';
    pluralName: 'contacts';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    displayEmail: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::contact.contact'
...
export interface ApiEmailTemplateEmailTemplate
  ...
  info: {
    description: 'Reusable templates for system emails (admin + user)';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.String;
    htmlBody: Schema.Attribute.Text;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    detailsImage: Schema.Attribute.Component<'event.detail-block', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::event.event'> &
      Schema.Attribute.Private;
    participants: Schema.Attribute.Media<'images', true>;
...
export interface ApiEventsPageEventsPage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Events list page hero background image and title';
...
export interface ApiHomeAboutUsHomeAboutUs extends Struct.SingleTypeSchema {
  collectionName: 'home_about_uses';
  info: {
    description: 'Home screen About Us: title, text lines, button name, link';
    displayName: 'Home About Us';
    pluralName: 'home-about-uses';
    singularName: 'home-about-us';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-about-us.home-about-us'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    text: Schema.Attribute.Component<'home-about-us.text-line', true>;
    title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHomePartnerWithUsHomePartnerWithUs
  extends Struct.SingleTypeSchema {
  collectionName: 'home_partner_with_uses';
  info: {
    description: 'Home screen Partner With Us: title, button, link, items (icon, title, subtitle)';
    displayName: 'Home Partner With Us';
    pluralName: 'home-partner-with-uses';
    singularName: 'home-partner-with-us';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    items: Schema.Attribute.Component<'home-partner-with-us.item', true>;
    link: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-partner-with-us.home-partner-with-us'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
...
export interface ApiNewsNewspost extends Struct.CollectionTypeSchema {
  collectionName: 'news';
  info: {
    description: 'Create news content';
    displayName: 'News';
    pluralName: 'news';
...
export interface ApiOperatingPartnerOperatingPartner
  extends Struct.CollectionTypeSchema {
  collectionName: 'operating_partners';
  info: {
    description: 'Operating partners';
    displayName: 'Operating Partner';
    pluralName: 'operating-partners';
    singularName: 'operating-partner';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::operating-partner.operating-partner'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiOurStoryOurStory extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Our Story section: header and items';
  ...
  attributes: {
    ...
    items: Schema.Attribute.Component<'our-story.item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiVaultStoryVaultStory extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Vault Story page content including hero image and details';
    displayName: 'Vault Story';
    pluralName: 'vault-stories';
    singularName: 'vault-story';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiWantToKnowMoreWantToKnowMore
  extends Struct.CollectionTypeSchema {
  collectionName: 'want_to_know_mores';
  info: {
    description: 'Want to know more section per path: path (e.g. /, /aboutus), title, buttonName, link';
    displayName: 'Want To Know More';
    pluralName: 'want-to-know-mores';
    singularName: 'want-to-know-more';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::want-to-know-more.want-to-know-more'
    > &
      Schema.Attribute.Private;
...
export interface ApiWhatWeDoWhatWeDo extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'What We Do section: header and items';
