    ...
    <div className={`py-4 py-lg-5 position-relative d-flex flex-column gap-4`}>
      ...
      <div className=' mb-5'>
        <Link href='pe_advisory'
          className={`d-block text-decoration-none what-we-do-content`}
        >
          <div className=' d-flex gap-3 what-we-do-text p-3'>
            ...
            <div className=' flex-grow-1 d-flex flex-column gap-3 justify-content-between'>
              <div className=' d-flex  justify-content-between align-items-center'>
                <div className='text-uppercase fw-medium fs-13 letter-spacing'>Wealth Structuring</div>
                <div className='text-uppercase fw-medium fs-13 letter-spacing'>December 7, 2025</div>
              </div>
              <div className='font-libre fs-24 '>
